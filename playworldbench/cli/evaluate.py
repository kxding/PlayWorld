#!/usr/bin/env python3
"""Score one video with exact dual-scale contact-sheet evidence and Gemini."""
...
from playworldbench.metrics.dual_sampling import (
    DualSamplingArtifacts,
    export_artifacts,
    generate_dual_sampling,
)
from playworldbench.metrics.gemini_metrics import (
    build_scoring_context,
    build_scoring_prompt,
)
from playworldbench.metrics.instruction_gate import build_gate_context, build_gate_prompt
